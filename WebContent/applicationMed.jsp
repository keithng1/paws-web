...
<title>Medical School Application</title>   <!--Import Google Icon Font-->
...
<div class="ui secondary vertical menu">
  ...
  <span class="item">
   ...
   <a class="item" style="padding-left: 20%;" href="application-grade-school.html" >
   Grade School
  </a>
  ...
  <a class="item" style="padding-left: 20%;" href="application-college.html">
   College
    ...
    <a class="item active" style="padding-left: 20%;" href="application-med.html">
   Medical Education
  </a>
...
<h1 style="color: #45484c;">Application for Survey Visit - Medical Education</h1>        
      <hr><br>
      <br><br>
...
<div class="ui one column grid">
     ...
     <div class="column">
         ...
         <span style="color: black;"><b>Institution</b></span><br>     </div>
    ...
    <input  style="width:100%;" type="text">
     ...
     <div class="column">
         <div style="padding-bottom: 1%;">
         <span style="color: black;"><b>Address</b></span><br>     </div>
    <div class="ui input" style="width: 100%;">
    <input type="text">
</div>
...
<div class="ui two column grid">
     <div class="row">
         <div class="column">
                ...
                <div style="padding-bottom: 1%;">
         <span style="color: black;"><b>Total Enrollment</b></span><br>     </div>
    <div class="ui input" style="width: 100%;">
    <input type="text">
</div>
            ...
            <div class="column">
                ...
                <div style="padding-bottom: 1%;">
         <span style="color: black;"><b>Number of Faculty Members</b></span><br>     </div>
    <div class="ui input" style="width: 100%;">
    <input type="text">
</div>
         ...
         <div class="column">
                ...
                <div style="padding-bottom: 1%;">
         <span style="color: black;"><b>Prefered Date 1</b></span><br>     </div>
    <div class="ui input" style="width: 100%;">
    <input type="text">
</div>
            ...
            <div class="column">
                ...
                <div style="padding-bottom: 1%;">
         <span style="color: black;"><b>Prefered Date 2</b></span><br>     </div>
    <div class="ui input" style="width: 100%;">
    <input type="text">
</div>
     ...
     <div style="padding-left: 5%;">
              ...
              <div style="padding-bottom: 1%;">
         <span style="color: black;"><b>Type of Visit Expected</b></span><br>     </div>
               <br>
...
<div class="ui two column grid">
    ...
    <div class="column">
                <div style="padding-bottom: 1%;">
         <span style="color: black;"><b>Administrator Name</b></span><br>     </div>
    <div class="ui input" style="width: 100%;">
    <input type="text"></div>
         </div>
     <div class="column">
                <div style="padding-bottom: 1%;">
         <span style="color: black;"><b>Designation</b></span><br>     </div>
    <div class="ui input" style="width: 100%;">
    <input type="text"></div>
